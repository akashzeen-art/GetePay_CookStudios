          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 animate-slide-up">
              ...
              <p className="text-2xl text-white/90 font-semibold">
                Welcome to Cook – Your Digital Gateway to Culinary Excellence
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-8 sm:p-12 space-y-6 animate-fade-in">
              <p className="text-lg text-white/90 leading-relaxed">
                At Cook, we believe that cooking should be accessible, flexible, and empowering. That's why we created a modern Video-on-Demand (VOD) cooking platform designed to bring the joy of cooking directly to your screen — anytime, anywhere.
              </p>

              <p className="text-lg text-white/90 leading-relaxed">
                Our platform offers a curated collection of high-quality cooking videos led by experienced chefs, focused on improving your culinary skills, creativity, and confidence in the kitchen. Whether you're a beginner or an advanced cook, our diverse video library helps you stay consistent with your cooking journey, at your own pace.
              </p>

              <p className="text-lg text-white/90 leading-relaxed">
                As a VOD (Video-on-Demand) cooking subscription service, Cook bridges the gap between traditional cooking classes and the demands of today's digital lifestyle. No more fixed schedules or crowded kitchens — just pure, uninterrupted cooking whenever you need it.
              </p>

              <div className="bg-yellow-500/20 rounded-xl p-6 my-8 border border-yellow-400/30">
                <h2 className="text-2xl font-bold text-white mb-4">Our Mission</h2>
                <p className="text-lg text-white/90 leading-relaxed">
                  To make cooking an everyday joy for everyone by delivering affordable, expert-guided, and delicious content that nurtures your culinary passion and skills.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12">
              {[
                ...
                { icon: <Users className="w-8 h-8" />, title: "Expert Chefs", desc: "Certified professionals" },
                { icon: <Clock className="w-8 h-8" />, title: "Flexible Schedule", desc: "Your own pace" },
                { icon: <Heart className="w-8 h-8" />, title: "Culinary Passion", desc: "Food & creativity" },
              ].map((feature, index) => (
                <div
                  key={index}
                ...
                >
                  <div className="text-yellow-500 flex justify-center mb-3">{feature.icon}</div>
